<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_diagnosticos").children().remove();
		$("#load_edit_diagnosticos").load("<?php echo base_url()?>index.php/diagnosticos/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/diagnosticos/cambiarestado',
			type: 'post',
