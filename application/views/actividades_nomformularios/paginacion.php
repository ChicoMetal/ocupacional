...
<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_actividades_nomformularios").children().remove();
		$("#load_edit_actividades_nomformularios").load("<?php echo base_url()?>index.php/actividades_nomformularios/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/actividades_nomformularios/cambiarestado',
			type: 'post',
	...
	function load_detalle(codigo){
		$.ajax({
				url: '<?php echo base_url()?>index.php/actividades_nomformularios/buscardetalle',
				type: 'post',
				data: "codigo="+codigo,
				success: function (data) {
			...
			<div class="box-content nopadding">
				<table class="table table-hover table-nomargin table-striped dataTable dataTable-reorder">
					...
					<tbody>
					<?php 
					if($actividades_nomformularios)
					foreach ($actividades_nomformularios as $data) {
						?>
