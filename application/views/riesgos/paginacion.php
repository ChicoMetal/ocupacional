...
<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_riesgos").children().remove();
		$("#load_edit_riesgos").load("<?php echo base_url()?>index.php/riesgos/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/riesgos/cambiarestado',
			type: 'post',
	...
	function load_detalle(codigo){
		$.ajax({
				url: '<?php echo base_url()?>index.php/riesgos/buscardetalle',
				type: 'post',
				data: "codigo="+codigo,
				success: function (data) {
