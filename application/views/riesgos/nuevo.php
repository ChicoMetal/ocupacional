...
$("#form_riesgos_detalle").validate({
		submitHandler: function(form){
			...
			var dataString = $(form).serialize();
	          ...
	          $.ajax({
            	type: "POST",
                url:"<?php echo base_url() ?>index.php/riesgos/guardar_detalle",
                data: dataString,
                success: function(data){
                
	                $.gritter.add({
						title: 'Riesgos',
						text: 'El riesgo ha sido guardada correctamente!',
						
					});
					$("#nombre_detalle").val("");
					load_detalle($("#codriesgoadd").val());
						...
						<div class="box">
							...
							<div class="box-content nopadding">
								<form 
									method="POST" 
									class='form-horizontal form-column form-bordered'
									id="form_riesgos_detalle"
									name="form_riesgos_detalle"
									>
									<input type="hidden" name="codriesgoadd" id="codriesgoadd">
									<div class="span6">
