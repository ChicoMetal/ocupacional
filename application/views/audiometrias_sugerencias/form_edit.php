...
<script>
	$(document).ready(function() {
		...
		$("#form_audiometrias_sugerencias_edit").validate({
		submitHandler: function(form){
		
			var dataString = $(form).serialize();
	          $.ajax({
            	type: "POST",
                url:"<?php echo base_url() ?>index.php/audiometrias_sugerencias/actualizar",
                data: dataString,
...
<form 
	...
	id="form_audiometrias_sugerencias_edit"
	name="form_audiometrias_sugerencias_edit"
	>
