<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_actividades").children().remove();
		$("#load_edit_actividades").load("<?php echo base_url()?>index.php/actividades/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/actividades/cambiarestado',
			type: 'post',
