<script type="text/javascript">
	...
	function editar_det(codigo){
		...
		$("#load_edit_detalle").load("<?php echo base_url()?>index.php/audiometrias/edit_detalle?codigo="+codigo);
	 	
	}
	function activar_det(codigo){
		$.ajax({
		url: '<?php echo base_url()?>index.php/audiometrias/cambiarestado_detalle',
		type: 'post',
...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-color box-bordered dark_blue_smal">
			<div class="box-title">
				<h3><i class="icon-list"></i> Detalles de <?php echo $audiometria ?></h3>
			</div>
...
<table class="table table-hover table-nomargin table-striped dataTable dataTable-reorder yellow_smal">
	...
	<tbody>
	<?php 
	if($detallesdeaudiometrias)
	foreach ($detallesdeaudiometrias as $data) {
		?>
			<tr>
