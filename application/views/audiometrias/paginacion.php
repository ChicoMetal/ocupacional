...
<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_audiometrias").children().remove();
		$("#load_edit_audiometrias").load("<?php echo base_url()?>index.php/audiometrias/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/audiometrias/cambiarestado',
			type: 'post',
	...
	function load_detalle(codigo){
		$.ajax({
				url: '<?php echo base_url()?>index.php/audiometrias/buscardetalle',
				type: 'post',
				data: "codigo="+codigo,
				success: function (data) {
