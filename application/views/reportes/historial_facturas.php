...
$(document).ready(function(){
     ...
     $("#buscar_facturas").click(function(){
		...
		codempresa=$("#codempresa").val();
     	...
     	dataString="fechainicio="+fechainicio+"&fechacorte="+fechacorte+"&codempresa="+codempresa;
			...
			$.ajax({
			type: "POST",
			url:"<?php echo base_url() ?>index.php/reportes/buscar_facturas",
			data: dataString,
	...
	function opendialogfactura(cod){
		$.ajax({
			url: '<?php echo base_url() ?>index.php/formatos/facturacion_dialog/'+cod,
			type: 'GET',
			data: "",

            success: function(data){
            	$("#load_factura_pdf").html(data)
            	$("#dialog_facturas").dialog("open")
...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-color green box-bordered">
			<div class="box-title">
				<h3><i class="icon-list"></i> Historial factura</h3>
			</div>
				...
				<form 
					...
					<div class="span12">
						<div class="form-actions">
							<button type="button" id="buscar_facturas" class="btn btn-blue">
								Buscar facturas
							</button>
						</div>
...
<div id="dialog_facturas">
<div id="load_factura_pdf"></div>
