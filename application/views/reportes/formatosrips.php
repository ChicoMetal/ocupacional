...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-color green box-bordered">
			<div class="box-title">
				<h3><i class="icon-list"></i> Generacion de rips</h3>
			</div>
			<div class="box-content">
				<form 
					method="POST" 
					class='form-horizontal form-column form-bordered'
					id="generarexcel_rips"
					name="generarexcel_rips"
					action="<?php echo base_url() ?>index.php/reportes/generarexcel_rips"
					>
