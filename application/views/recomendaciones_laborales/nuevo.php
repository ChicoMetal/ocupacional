...
$("#form_recomendaciones_laborales_detalle").validate({
		submitHandler: function(form){
	
			var dataString = $(form).serialize();
			//alert($("#codrecomendaciones_laboraleadd").val());
	          $.ajax({
            	type: "POST",
                url:"<?php echo base_url() ?>index.php/recomendaciones_laborales/guardar_detalle",
                data: dataString,
                success: function(data){
                
	                $.gritter.add({
						title: 'recomendaciones_laborales',
						text: 'El recomendaciones_laborale ha sido guardada correctamente!',
						
					});
					$("#nombre_detalle").val("");
					load_detalle($("#codrecomendaciones_laboraleadd").val());
						...
						<div class="box">
							...
							<div class="box-content nopadding">
								<form 
									method="POST" 
									class='form-horizontal form-column form-bordered'
									id="form_recomendaciones_laborales_detalle"
									name="form_recomendaciones_laborales_detalle"
									>
									<input type="hidden" name="codrecomendaciones_laboraleadd" id="codrecomendaciones_laboraleadd">
									<div class="span6">
