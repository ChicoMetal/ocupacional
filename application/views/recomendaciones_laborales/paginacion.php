...
<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_recomendaciones_laborales").children().remove();
		$("#load_edit_recomendaciones_laborales").load("<?php echo base_url()?>index.php/recomendaciones_laborales/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/recomendaciones_laborales/cambiarestado',
			type: 'post',
	...
	function load_detalle(codigo){
		$.ajax({
				url: '<?php echo base_url()?>index.php/recomendaciones_laborales/buscardetalle',
				type: 'post',
				data: "codigo="+codigo,
				success: function (data) {
			...
			<div class="box-content nopadding">
				<table class="table table-hover table-nomargin table-striped dataTable dataTable-reorder">
					...
					<tbody>
					<?php 
					if($recomendaciones_laborales)
					foreach ($recomendaciones_laborales as $data) {
						?>
