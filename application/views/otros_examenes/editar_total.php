	...
	<div class="box-content nopadding">
		<div class="tabs-container">
			 <ul class="tabs tabs-inline tabs-top">
		        ...
		        <li id="tab_otros_diagnosticos">
		          <a href="#datos_otros_diagnosticos" data-toggle='tab'><strong>Disgnosticos examenes</strong></a>
		        </li>
		...
		<div class="tab-content padding tab-content-inline tab-content-bottom">
			...
			<div class="tab-pane" id="datos_otros_diagnosticos">
				<div id="load_otros_diagnosticos"></div>
			</div>
