<script>
	$(document).ready(function() {
	 ...
	 function editar(codigo){
	 	...
	 	$("#load_edit_tipo_examenes").children().remove();
		$("#load_edit_tipo_examenes").load("<?php echo base_url()?>index.php/tipo_examenes/edit?codigo="+codigo);
	 	
	 }

	 function activar(codigo){
	 	$.ajax({
			url: '<?php echo base_url()?>index.php/tipo_examenes/cambiarestado',
			type: 'post',
