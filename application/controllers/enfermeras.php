...
class enfermeras extends CI_Controller{
    ...
    function index(){
        ...
        $data['contenido_principal']="enfermeras/index";
        $data['ses']=$this->ses;
        $data['active']="administracion";
        $data['active2']="administracion";

        

        $this->load->view('includes/enfermeras/tpl_enfermeras.php',$data);
    }
