...
abstract class gosUtility_Parallel {
     ...
     *  - Setup logging
     */
    protected function __construct($maxWorkers) {
    ...
    /**
     * Cleanup stuff for the parent to do; executed after doWorkParent() returns
     */
    ...
    /**
     * Cleanup stuff for the parent to do; executed after doWorkChild() returns
     */
    ...
    public static function signalHandler($signal) {
        ...
        case SIGINT:
            $sig = 'SIGINT';
            echo "Caught $sig, stopping children\n";
        case SIGTERM:
